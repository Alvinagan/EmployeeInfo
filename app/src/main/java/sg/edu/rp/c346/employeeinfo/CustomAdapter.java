...
public class CustomAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
        ...
        EmployeeItem curremtItem = employeeList.get(position);
        tvName.setText(curremtItem.getEmployeeName());
        tvTitle.setText(curremtItem.getEmployeeTitle());
        tvSalary.setText(curremtItem.getEmployeeSalary());
